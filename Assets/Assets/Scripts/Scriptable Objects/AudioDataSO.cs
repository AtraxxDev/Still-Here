...
public class AudioDataSO : ScriptableObject
{
    ...
    public AudioClip GetMusicClip(string name) => musicDict.TryGetValue(name, out var clip) ? clip : null;
    public AudioClip GetSFXClip(string name) => sfxDict.TryGetValue(name, out var clip) ? clip : null;
}
